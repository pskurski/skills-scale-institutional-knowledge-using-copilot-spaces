...
This README introduces and links to the OctoAcme Project Management documentation. The docs below describe the processes, roles, and practices used to plan, execute, and deliver projects at OctoAcme.
